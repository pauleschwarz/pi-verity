...
export type ScopeSignalCode = "SCOPE_DEPENDENCY_ADDED" | "SCOPE_LOCKFILE_CHANGED" | "SCOPE_TEST_DELETED" | "SCOPE_TEST_RENAMED" | "SCOPE_TEST_SKIPPED" | "SCOPE_LINT_SUPPRESSION_ADDED" | "SCOPE_TYPE_SUPPRESSION_ADDED" | "SCOPE_GENERATED_FILE_MODIFIED" | "SCOPE_PACKAGE_BUILD_CONFIG_MODIFIED" | "SCOPE_MIGRATION_MODIFIED" | "SCOPE_PUBLIC_API_CHANGED" | "SCOPE_SECRET_LIKE_FILE_ADDED" | "SCOPE_BINARY_ADDED" | "SCOPE_BROAD_FILE_SPREAD";
...
export type CounterfactualClassification = "PROVEN_REGRESSION" | "NON_DISCRIMINATING_TEST" | "BASELINE_UNAVAILABLE" | "TEST_NOT_PORTABLE" | "CANDIDATE_FAILS" | "INCONCLUSIVE";
export type AntiGamingSignalKind = "TEST_SKIPPED" | "ASSERTION_REMOVED" | "TEST_DELETED" | "SUPPRESSION_INTRODUCED" | "UNCONDITIONAL_SUCCESS";
 ...
 */
export type ObservableClaimKind = "EXACT_TEXT_PRESENT" | "EXACT_TEXT_ABSENT" | "STYLE_VALUE" | "VISIBILITY" | "NUMERIC_UI_VALUE" | "ROUTE_HINT";
/**
...
export type EffectStatus = "SOURCE_OBSERVED" | "RUNTIME_OBSERVED" | "UNCHECKED" | "SOURCE_CONTRADICTED" | "RUNTIME_CONTRADICTED";
 ...
 */
export type ExternalEvidenceStatus = "PASS" | "FAIL" | "INCOMPLETE" | "UNAVAILABLE" | "MALFORMED";
