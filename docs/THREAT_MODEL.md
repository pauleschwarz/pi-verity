...
- network disabled where technically enforceable for isolated counterfactual execution
- path canonicalization
- no automatic package install

Residual risk:

Running arbitrary repository scripts without an OS/container sandbox remains dangerous.
